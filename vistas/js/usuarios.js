...
$(".nuevaFoto").change(function(){
    ...
    if (imagen) {
        ...
        // Si no se selecciona una imagen, puedes mostrar un mensaje o realizar otras acciones si es necesario
    }
});
...
$(".tablas").on("click", ".btnEditarUsuario", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$("#editarapellidoPa").val(respuesta["apellidoPa"]);
			$("#editarapellidoMa").val(respuesta["apellidoMa"]);
