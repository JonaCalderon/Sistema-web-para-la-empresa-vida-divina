     ...
     $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
          	...
          	var precio_descuento = Number(precio) - Number(precio)*Number(descuento)/100;
	          ...
	          '<div class="col-xs-3 ingresoPrecio" style="padding-left:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<input type="text" class="form-control nuevoPrecioProducto" precioReal="'+precio_descuento+'" name="nuevoPrecioProducto" value="'+precio_descuento+'" readonly required>'+
