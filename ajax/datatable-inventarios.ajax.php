...
class TablaInventario{
    ...
    public function mostrarTablaInventario(){
        ...
        $productos = ControladorInventarios::ctrMostrarProductos($item, $valor, $orden);
        ...
        for($i = 0; $i < count($productos); $i++){
            ...
            FECHA DE CADUCIDAD
            =============================================*/
            $fechaCaducidad = date("d/m/Y", strtotime($productos[$i]["fecha_caducidad"]));
...
=============================================*/ 
$activarProductos = new TablaInventario();
$activarProductos -> mostrarTablaInventario();
